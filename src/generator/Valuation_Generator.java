...
public class Valuation_Generator implements IdentifierGenerator {
	...
	public Serializable generate(SessionImplementor session, Object object)
		...
		//------------------------------------------------
		String tableName="Valuation"; //table名稱
		String fieldName="vlt_id";      //"編號"欄位名稱
		String name="V";                //編號專屬開頭代號
		//------------------------------------------------------
